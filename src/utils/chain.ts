...
export class ChainUtils {
  ...
  static getL1TokenAddress(chainId: EChain): string | undefined {
    ...
    const l1TokenAddresses: Partial<Record<EChain, string>> = {
      // Mainnet
      [EChain.ETHEREUM]: '0xdac17f958d2ee523a2206206994597c13d831ec7', // USDT on Ethereum
      [EChain.ARBITRUM_ONE]: '0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9', // USDT on Arbitrum
      // Testnet
      [EChain.ETHEREUM_SEPOLIA]: '0xfb122130c4d28860dbc050a8e024a71a558eb0c1', // USDT on Sepolia
  ...
  static getRpcUrl(chainId: EChain): string | undefined {
    ...
    const rpcUrls: Partial<Record<EChain, string>> = {
      // Mainnet
      [EChain.ETHEREUM]: 'https://eth.llamarpc.com',
      [EChain.ARBITRUM_ONE]: 'https://arb1.arbitrum.io/rpc',
      // Testnet
      [EChain.ETHEREUM_SEPOLIA]: 'https://rpc.sepolia.org',
      [EChain.ARBITRUM_SEPOLIA]: 'https://sepolia-rollup.arbitrum.io/rpc',
    };
